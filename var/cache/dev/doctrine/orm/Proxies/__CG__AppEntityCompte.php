...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'NumeroCompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'Solde', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'Entreprise', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'utilisateurs', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depots'];
        }
