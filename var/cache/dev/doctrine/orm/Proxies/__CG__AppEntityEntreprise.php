...
class Entreprise extends \App\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'RaisonSociale', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'Ninea', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'Adresse', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'Status', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'utilisateurs', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'comptes'];
        }
