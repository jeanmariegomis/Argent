...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/envoi'), [0 => 'admin'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/entreprise'), [0 => 'Super_admin'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/utilisateur'), [0 => 'amin_Principal'], NULL);
